...
const PostEvent = ({ setSelectedView }) => {
  ...
  const handlePostEvent = async (e) => {
    ...
    try {
      const uploadedImages = await Promise.all(
        formData.files.map((item) => uploadImage(item.file, "events")),
      );
      ...
      await eventService.createEvent(eventToPost);
    ...
    <div className="w-[84vw] h-screen flex flex-col justify-start items-center">
      <div className="flex gap-1 justify-between items-center w-[72%] px-5 mt-10 mb-4">
        <div className="flex flex-col">
          ...
          <p className="contentText text-base">
            Organize and promote campus events to engage the community
          </p>
        </div>
      </div>
      ...
      {isForm && (
        <div className="w-[70%]">
          <form
            ...
            className="h-fit border border-gray-700 bg-indigo-950/50 rounded-lg my-4 p-6"
          >
            <div className="flex flex-col gap-1 mb-8">
              ...
              <input
                ...
                className="border border-gray-700 contentText bg-[#020818] px-4 py-2 text-base rounded-md outline-none"
                required
              />
            </div>
            ...
            <div className="flex gap-1 my-8">
              <div className="flex flex-col gap-1 w-1/2">
                <label htmlFor="organiser" className="text-sm px-2">
                  Organiser Name or Club *
                </label>
                <input
                  type="text"
                  name="organiser"
                  ...
                  id="organiser"
                  placeholder="E.g., GDG or Saksham Jaiswal"
                  className="border border-gray-700 contentText bg-[#020818] px-4 py-2 text-base rounded-md outline-none"
                  required
                />
              </div>
              ...
              <div className="flex flex-col gap-1 w-1/2">
                <label htmlFor="contactInfo" className="text-sm px-2">
                  Contact Email / Phone *
                </label>
                <input
                  type="text"
                  ...
                  id="contactInfo"
                  placeholder="e.g., john@example.com or +91-90000-00000"
                  className="border border-gray-700 contentText bg-[#020818] px-4 py-2 text-base rounded-md outline-none"
                  required
                />
              </div>
            ...
            <div className="flex flex-col gap-1 my-8">
              <label htmlFor="description" className="text-sm px-2">
                Description *
              </label>
              <textarea
                rows={6}
                ...
                id="description"
                placeholder="Describe your event, including agenda, requirements, and what attendees can expect..."
                className="border border-gray-700 contentText bg-[#020818] px-4 py-2 text-base rounded-md outline-none"
                required
              ></textarea>
            </div>
            ...
            <div className="flex flex-col gap-1 mb-8">
              <label htmlFor="venue" className="text-sm px-2">
                Enter Venue *
              </label>
              <input
                type="text"
                ...
                id="venue"
                placeholder="Enter Event Venue (e.g., Main Auditorium, Computer Lab)"
                className="border border-gray-700 contentText bg-[#020818] px-4 py-2 text-base rounded-md outline-none"
                required
              />
            </div>
            ...
            <div className="flex gap-1 my-8">
              <div className="flex flex-col gap-1 my-1 w-1/2 relative">
                ...
                <input
                  ...
                  id="startDate"
                  className="!appearance-none border border-gray-700 contentText bg-[#020818] px-4 py-2 text-base rounded-md outline-none"
                  required
                />
                <div className="pointer-events-none absolute inset-y-0 right-3 top-6 flex items-center px-3">
                  <svg
                    className="w-5 h-5 contenText"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
                    viewBox="0 0 24 24"
            ...
            <div className="flex justify-center items-center gap-1 my-8">
              <div className="flex flex-col gap-1 w-1/2">
                <label htmlFor="capacity" className="text-sm px-2">
                  Event Capacity *
                </label>
                <input
                  type="number"
              ...
              <div className="flex flex-col gap-1 my-1 w-1/2 px-2">
                <label htmlFor="targetaudience" className="text-sm px-2">
                  Target Audience
                </label>
                <select
                  name="targetaudience"
                  ...
                  id="targetaudience"
                  className="bg-[#020818] outline-none border border-gray-700 rounded-sm px-4 py-2"
                >
                  ...
                  <option value="Cybersecurity Department">
            ...
            <div className="flex flex-col gap-1 my-8">
              <label htmlFor="tags" className="text-sm px-2">
                Tags
              </label>
              <input
                type="text"
                ...
                id="tags"
                placeholder="Enter tags separated by commas (e.g., important, deadline, academics)"
                className="border border-gray-700 contentText bg-[#020818] px-4 py-2 text-base rounded-md outline-none"
              />
              <p className="text-[#96aac5] text-[0.82rem] px-2">
                Separate multiple tags with commas
              </p>
            </div>

            <div className="flex flex-col my-8 relative">
              <label htmlFor="eventposter" className="text-sm px-2 mb-1">
                Event Banner
              </label>
              {formData.files.length == 0 ? (
                ...
                >
                  <div className="relative cursor-pointer border-2 border-dashed border-gray-700 group-hover:border-gray-500 transition-colors bg-[#020818] px-4 py-2 h-48 text-base rounded-md flex flex-col items-center justify-center gap-0">
                    <div className="h-20 w-20 rounded-full bg-gray-900 flex items-center justify-center group-hover:bg-gray-800 transition-colors">
                      <svg
                        className="w-10 h-10 contentText group-hover:!text-white transition-colors"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="2"
                        viewBox="0 0 24 24"
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          d="M4 16v1a2 2 0 002 2h12a2 2 0 002-2v-1M12 12v8m0-8l3.5 3.5M12 12L8.5 15.5M16 8V4H8v4"
                        />
                      </svg>
                    </div>
                    <span className="text-xl font-bold mt-2" id="fileName">
                      Upload Event Banner
                    </span>
                    <p className="text-muted-foreground text-sm">
                      Upload an image to make your event more attractive (JPG,
                ...
                <div className="flex justify-center items-center w-full gap-4">
                  {formData.files.map((file, i) => (
                    <div
                      key={i}
                      className="relative rounded-xl bg-muted overflow-hidden group w-[98%] aspect-[16/5]"
                    >
                      <img
                        src={file.preview}
                        alt="Preview"
            ...
            <div className="flex gap-4 my-5">
              <button
                type="submit"
                className={`${loading ? "cursor-not-allowed bg-gray-700 hover:bg-gray-700" : "cursor-pointer bg-indigo-600 hover:bg-indigo-700"} btnText px-5 py-3 rounded-sm text-sm transition-all duration-200 ease-in-out`}
                disabled={loading}
              >
              ...
              <button
                ...
                className="cursor-pointer btnText bg-indigo-600/30 hover:bg-indigo-600/50 px-5 py-3 rounded-sm text-sm transition-all duration-200 ease-in-out"
              >
                Reset Form
              </button>
            </div>
        ...
        >
          ...
          <div className="space-y-3 w-full flex flex-col text-center justify-center items-center">
            ...
            <p className="text-lg contentText max-w-md mx-auto">
              Your event has been posted successfully. It is now visible to
              users and participants can start engaging with it.
            </p>
          </div>
          ...
          <div className="flex w-[70%] justify-between items-center gap-4 mt-16">
            <div
              variant="outline"
              size="lg"
              className="flex justify-center items-center h-14 bg-indigo-600/30 hover:bg-indigo-600/50 btnText rounded-lg px-12 py-2 cursor-pointer gap-2"
              onClick={() => {
                setIsSuccess(false);
                setIsForm(true);
                handleResetForm();
            ...
            >
              <ChevronLeft className="h-4 w-4" /> Post Another Event
            </div>
            <div
              size="lg"
              className="flex justify-center items-center h-14 bg-indigo-600 hover:bg-indigo-700 btnText rounded-lg px-16 py-2 cursor-pointer gap-2"
            >
              <button
                onClick={() => {
      ...
      {isFailed && (
        ...
        >
          ...
          <div className="space-y-3 w-full flex flex-col text-center justify-center items-center">
            <h2 className="text-4xl font-extrabold subtitle">
              Failed to Post Event
            </h2>
            <p className="text-lg contentText max-w-md mx-auto">
              We couldn&apos;t post your event at the moment. Please try again
              in a few seconds.
            </p>
          </div>
