...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full px-5 py-4 hidden md:flex md:flex-col bg-[#020818] border-r border-gray-700 w-[300px] shrink-0 fixed top-0 left-0",
          className
        )}
        animate={{
...
export const SidebarLink = ({
  ...
  return (
    <a
      // href={link.href}
      className={cn("flex items-center justify-start gap-3 group/sidebar py-2 px-2 navText cursor-pointer", className)}
      {...props}>
      {link.icon}
      <motion.span
        animate={{
