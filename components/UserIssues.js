              ...
              <div key={announcement.id} className='w-full !h-[40vh] border border-gray-800 bg-[#020613] rounded-lg overflow-hidden'>
                <div className='relative w-full h-full flex justify-center items-center pl-8 gap-4 hover:bg-gray-900/20 transition-all duration-200 ease-in-out group'>
                  ...
                  <div className='absolute bottom-0 right-0 flex'>
                    <Link href="/" className=''><span className='mr-4 mb-4 contentText py-2 px-2 rounded-lg !text-blue-400 text-xs hover:!text-blue-500 transition-all duration-300 ease-in-out flex justify-center items-center gap-1'><FaRegThumbsUp /> {announcement.upvotes} Votes</span></Link>
