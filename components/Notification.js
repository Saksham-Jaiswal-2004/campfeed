    ...
    <div className='w-full h-screen overflow-y-scroll flex flex-col justify-start items-center px-5'>
      ...
      <div className='flex justify-between w-full relative'>
        <div className='flex justify-between items-center w-[75%] bg-indigo-900/20 rounded-sm px-2 py-1'>
          <p className={`${view === "ALL" ? "bg-indigo-800/80" : "hover:bg-indigo-800/20"} w-[16%] flex justify-center items-center px-2 py-1 rounded-sm cursor-pointer`} onClick={() => setView("ALL")}>All</p>
          <p className={`${view === "ISSUE" ? "bg-indigo-800/80" : "hover:bg-indigo-800/20"} w-[16%] flex justify-center items-center px-2 py-1 rounded-sm cursor-pointer`} onClick={() => setView("ISSUE")}>Issue</p>
          <p className={`${view === "COMMENT" ? "bg-indigo-800/80" : "hover:bg-indigo-800/20"} w-[16%] flex justify-center items-center px-2 py-1 rounded-sm cursor-pointer`} onClick={() => setView("COMMENT")}>Comments</p>
          <p className={`${view === "ANNOUNCEMENT" ? "bg-indigo-800/80" : "hover:bg-indigo-800/20"} w-[16%] flex justify-center items-center px-2 py-1 rounded-sm cursor-pointer`} onClick={() => setView("ANNOUNCEMENT")}>Announcement</p>
          <p className={`${view === "EVENT" ? "bg-indigo-800/80" : "hover:bg-indigo-800/20"} w-[16%] flex justify-center items-center px-2 py-1 rounded-sm cursor-pointer`} onClick={() => setView("EVENT")}>Events</p>
          <p className={`${view === "SYSTEM" ? "bg-indigo-800/80" : "hover:bg-indigo-800/20"} w-[16%] flex justify-center items-center px-2 py-1 rounded-sm cursor-pointer`} onClick={() => setView("SYSTEM")}>System</p>
        </div>
