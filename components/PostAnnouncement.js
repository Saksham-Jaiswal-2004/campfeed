...
const PostAnnouncement = ({ setSelectedView }) => {
            ...
            {isSuccess && (
              ...
              >
                ...
                <div className="space-y-3 w-full flex flex-col text-center justify-center items-center">
                  <h2 className="text-4xl font-extrabold subtitle">Announcement Issued</h2>
                  <p className="text-lg contentText max-w-md mx-auto">
                    Your announcement has been posted successfully. It is now visible to
                    students and other users can start engaging with it.
                  </p>
                </div>
                ...
                <div className="flex w-[70%] justify-between items-center gap-4 mt-16">
                  <div
                    variant="outline"
                    size="lg"
                    className="flex justify-center items-center w-fit h-14 bg-indigo-600/30 hover:bg-indigo-600/50 btnText rounded-lg px-4 py-2 cursor-pointer gap-2"
                    onClick={() => {
                      setIsSuccess(false);
                      setIsForm(true);
                      handleResetForm();
                  ...
                  >
                    <ChevronLeft className="h-4 w-4" /> Post Another Announcement
                  </div>
                  <div
                    size="lg"
            ...
            {isFailed && (
              ...
              >
                ...
                <div className="space-y-3 w-full flex flex-col text-center justify-center items-center">
                  ...
                  <p className="text-lg contentText max-w-md mx-auto">
                    We couldn&apos;t post your announcement at the moment. Please try again
                    in a few seconds.
                  </p>
                </div>
